...
define('GROQ_API_KEY', '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');
    ...
    $messages = [
        [
            ...
            "content" => '
                        ...
                        Contoh output
                        ayam, sayur, rendah kalori, vegetarian, makanan Itali
                        '
        ],
        [
            "role" => "user",
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    elseif ($action === 'reset_chat') {
        ...
        $_SESSION['conversation'] = [
            [
                'role' => 'system',
                'content' => 'Anda adalah Pakar Pemakanan Berlesen dan AI Assistant Resepi Sihat. Tugas anda adalah membantu pengguna mencari resepi yang paling sesuai berdasarkan keperluan pemakanan, citarasa, dan gaya hidup mereka. Berikan jawapan hanya dalam bahasa Melayu'
            ]
        ];
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-lg p-6">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-xl font-bold text-gray-800">Asisten Resepi AI</h2>
                <button id="reset-chat" class="bg-red-100 hover:bg-red-200 text-red-700 px-4 py-2 rounded-lg font-medium transition">
                    <i class="fas fa-sync-alt mr-2"></i>Mulai Baru
                </button>
            </div>
            ...
            <div class="bg-gray-100 rounded-xl p-4 mb-6">
                ...
                <form id="chat-form" class="mt-6">
                    <div class="flex">
                        ...
                        <button type="submit" id="send-button" class="bg-primary hover:bg-secondary text-white px-6 rounded-r-lg transition">
        ...
        $(document).ready(function() {
            ...
            function appendUserMessage(message) {
                const messageHtml = `
                    <div class="mb-4">
                        <div class="flex justify-end mb-2">
                            <div class="bg-primary text-white px-4 py-3 chat-bubble-user max-w-[80%]">
                                ${message}
                            </div>
                        </div>
                    </div>
