    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-16">
            <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900">
                Kelebihan ResepiSihat
            </h2>
            <p class="mt-4 text-lg md:text-xl text-gray-600">
                Aplikasi kami menawarkan pelbagai fungsi untuk memudahkan perancangan pemakanan harian anda
            </p>
        </div>
        
        <!-- Mobile: Horizontal Scroll Container -->
        <div class="md:hidden scroll-container overflow-x-auto pb-6 -mx-4 px-4">
            <div class="flex space-x-4 w-max min-w-full">
                <!-- Card 1 -->
                <div class="feature-card bg-gray-50 rounded-xl p-6 w-80 flex-shrink-0">
                ...
                <div class="feature-card bg-gray-50 rounded-xl p-6 w-80 flex-shrink-0">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2">Tutorial Video</h3>
                    <p class="text-gray-600 text-sm">
                        Belajar teknik memasak yang betul melalui koleksi video tutorial daripada chef profesional.
                    </p>
                </div>
                ...
                <div class="feature-card bg-gray-50 rounded-xl p-6 w-80 flex-shrink-0">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 mb-2">Komuniti Interaktif</h3>
                    <p class="text-gray-600 text-sm">
                        Berinteraksi dengan komuniti pemakanan sihat, beri ulasan, dan dapatkan sokongan untuk gaya hidup sihat.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="hidden md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="feature-card bg-gray-50 rounded-xl p-8">
                <div class="feature-icon bg-green-100 p-4 rounded-xl w-16 h-16 flex items-center justify-center mb-6">
                    <i class="fas fa-lightbulb text-green-700 text-2xl"></i>
                </div>
            ...
            <div class="feature-card bg-gray-50 rounded-xl p-8">
                <div class="feature-icon bg-green-100 p-4 rounded-xl w-16 h-16 flex items-center justify-center mb-6">
                    <i class="fas fa-film text-green-700 text-2xl"></i>
                </div>
                <h3 class="text-xl font-bold text-gray-900 mb-3">Tutorial Video</h3>
                <p class="text-gray-600 mb-4">
                    Belajar teknik memasak yang betul melalui koleksi video tutorial daripada chef profesional.
                </p>
            </div>
            ...
            <div class="feature-card bg-gray-50 rounded-xl p-8">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Komuniti Interaktif</h3>
                <p class="text-gray-600 mb-4">
                    Berinteraksi dengan komuniti pemakanan sihat, beri ulasan, dan dapatkan sokongan untuk gaya hidup sihat.
                </p>
            </div>
...
<script>
    // Simple hover effect enhancement for touch devices
