<div style='min-height:100dvh' class="hero-pattern pt-32 pb-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div class="mb-12 lg:mb-0">
                <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">
                    Pemakanan <span class="text-primary-600">Sihat</span>, Hidup Bahagia
                </h1>
                <p class="mt-5 text-xl text-gray-600 max-w-2xl">
            ...
            <div class="mt-12 flex flex-wrap gap-8">
                ...
                <div class="flex items-center">
                    ...
                    <div class="text-gray-700">Cadangan berdasarkan bahan sedia ada</div>
                </div>
            </div>
            <br>
            </div>
            <div class="relative hidden md:block">
                <div class="hero-img">
                    <div class="relative">
                        <!-- <div class="absolute -top-8 -left-8 w-full h-full rounded-2xl bg-primary-100 z-0"></div> -->
                         <img style="max-height: 400px" src="https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80" 
                            alt="Sup Ayam" 
                            class="w-full w-full object-cover rounded">
                    </div>
                </div>
                <div class="absolute -bottom-6 -right-6 bg-white rounded-xl shadow-lg p-5 z-20 w-3/4">
                    <div class="flex items-center">
